# Quick Start: Categorizing Sources

## How to Add Categories to Sources
...
6. **Close Dialog**
   ...
   - No need to click "Save Changes" for categories
...
2. **Edit to Add Categories**
   - After creation, you'll see a toast message
...
- **History** - Historical analysis and documentaries
...
✅ **Multiple Categories**: You can add multiple categories to a source (e.g., "News" + "Politics" + "Leans Left")

✅ **Search**: Use the search box in the category dropdown to quickly find categories

✅ **Visual**: Each category has a unique color to make it easy to identify

✅ **Instant Save**: Categories are saved immediately when you add/remove them

✅ **Browse**: Visit `/categories` to see all categories and browse sources by category
...
4. Share category pages with others to help them find sources

## Need Help?

- Check `/docs/CATEGORY_FRONTEND_INTEGRATION.md` for technical details
- Check `/docs/CATEGORIES.md` for complete category system documentation
- Visit `/admin` → Categories tab to manage categories (admin only)
